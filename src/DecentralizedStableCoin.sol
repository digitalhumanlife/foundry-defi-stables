...
contract DecentralizedStableCoin is ERC20Burnable, Ownable {
    error DencentralizedStableCoin__MustBeMoreThanZero();
    error DecentralizedStableCoin__BurnAmount();
    ...
    function burn(uint256 _amount) public override onlyOwner {
        ...
        if (_amount <= 0) {
            revert DencentralizedStableCoin__MustBeMoreThanZero();
        }
        if (_amount > balance) {
