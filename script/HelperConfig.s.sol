...
contract HelperConfig is Script {
    struct NetworkConfig {
        address wethUsdPriceFeed; //from CL
        address wbtcUsdPriceFeed; //from CL
        address weth; // **DO WE REALLY NEED THIS? mock tokens?
        address wbtc; // DO WE NEED REALLY THIS?
        uint256 deployerKey; // deployer signer
    }
